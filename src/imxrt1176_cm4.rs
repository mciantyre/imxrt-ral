...
pub mod dma {
    #[doc = "DMA"]
    pub const DMA: *mut RegisterBlock = 0x40c1_4000 as *mut RegisterBlock;
...
pub mod dmamux {
    #[doc = "DMAMUX"]
    pub const DMAMUX: *mut RegisterBlock = 0x40c1_8000 as *mut RegisterBlock;
...
pub mod lmem {
    #[doc = "LMEM"]
    pub const LMEM: *mut RegisterBlock = 0xe008_2000 as *mut RegisterBlock;
...
pub mod mcm {
    ...
    pub const MCM: *mut RegisterBlock = 0xe008_0000 as *mut RegisterBlock;
...
pub mod mmcau {
    #[doc = "CAU"]
    pub const MMCAU: *mut RegisterBlock = 0xe008_1000 as *mut RegisterBlock;
...
pub mod mub {
    #[doc = "MUB"]
    pub const MUB: *mut RegisterBlock = 0x40c4_c000 as *mut RegisterBlock;
