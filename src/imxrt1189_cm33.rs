...
pub mod sys_tick0 {
    ...
    pub use blocks::*;
    pub type Instance<const N: u8> = crate::Instance<RegisterBlock, N>;
    pub type SYSTICK0 = Instance<{ crate::SOLE_INSTANCE }>;
    impl crate::private::Sealed for SYSTICK0 {}
    impl crate::Valid for SYSTICK0 {}
    impl SYSTICK0 {
        #[doc = r" Acquire a vaild, but possibly aliased, instance."]
        #[doc = r""]
        #[doc = r" # Safety"]
        ...
        #[inline]
        pub const unsafe fn instance() -> Self {
            Instance::new(SYSTICK0)
        }
    }
    #[doc = r" Returns the instance number `N` for a peripheral instance."]
    pub fn number(rb: *const RegisterBlock) -> Option<u8> {
        core::ptr::eq(rb, SYSTICK0).then_some(0)
    }
}
#[path = "."]
pub mod tmpsns {
...
pub struct Instances {
    ...
    pub SYSTICK0: sys_tick0::SYSTICK0,
...
impl Instances {
    ...
    pub const unsafe fn instances() -> Self {
        Self {
            ...
            SYSTICK0: sys_tick0::SYSTICK0::instance(),
