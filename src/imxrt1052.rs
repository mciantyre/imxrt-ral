...
pub mod ccm_analog {
    ...
    #[path = "blocks/imxrt1051/ccm_analog.rs"]
    mod blocks;
    pub use blocks::*;
    pub type Instance<const N: u8> = crate::Instance<RegisterBlock, N>;
...
pub mod enet {
    ...
    pub const ENET: *mut RegisterBlock = 0x402d_8000 as *mut RegisterBlock;
...
pub mod flexio {
    ...
    #[path = "blocks/imxrt1051/flexio.rs"]
    mod blocks;
    pub use blocks::*;
    pub type Instance<const N: u8> = crate::Instance<RegisterBlock, N>;
...
pub mod flexspi {
    #[doc = "FlexSPI"]
    pub const FLEXSPI: *mut RegisterBlock = 0x402a_8000 as *mut RegisterBlock;
...
pub mod gpio {
    ...
    #[doc = r" Returns the instance number `N` for a peripheral instance."]
    pub fn number(rb: *const RegisterBlock) -> Option<u8> {
        [(GPIO1, 1), (GPIO5, 5), (GPIO2, 2), (GPIO3, 3), (GPIO4, 4)]
            .into_iter()
            .find(|(ptr, _)| core::ptr::eq(rb, *ptr))
            .map(|(_, inst)| inst)
    }
...
pub mod iomuxc {
    ...
    #[path = "blocks/imxrt1051/iomuxc.rs"]
    mod blocks;
    pub use blocks::*;
    pub type Instance<const N: u8> = crate::Instance<RegisterBlock, N>;
...
pub mod iomuxc_gpr {
    ...
    #[path = "blocks/imxrt1051/iomuxc_gpr.rs"]
    mod blocks;
    pub use blocks::*;
    pub type Instance<const N: u8> = crate::Instance<RegisterBlock, N>;
...
pub mod lcdif {
    ...
    #[path = "blocks/imxrt1052/lcdif.rs"]
    mod blocks;
    pub use blocks::*;
    pub type Instance<const N: u8> = crate::Instance<RegisterBlock, N>;
...
pub mod usb_analog {
    ...
    #[path = "blocks/imxrt1051/usb_analog.rs"]
    mod blocks;
    pub use blocks::*;
    pub type Instance<const N: u8> = crate::Instance<RegisterBlock, N>;
