...
pub mod PCI_CFC_PCIPM_CTL_STAT {
    ...
    #[doc = "PME enable Enable function to generate PM_PME messages to Root Complex Event Collector."]
    pub mod PME_EN {
        pub const offset: u16 = 8;
        pub const mask: u16 = 0x01 << offset;
        pub use super::access;
    ...
    #[doc = "PME status This bit is set to 1b when the function detects a Wake-on-LAN event independent of the state of the PME_EN bit"]
    pub mod PME_STATUS {
        pub const offset: u16 = 15;
        pub const mask: u16 = 0x01 << offset;
        pub use super::access;
