...
pub mod SIMCAR {
    pub use crate::RW as access;
    #[doc = "SI messaging write cache type This is the cache attribute setting used when NETC writes PSI-VSI message during partition copy"]
    pub mod MSG_WRCACHE {
        pub const offset: u32 = 0;
        pub const mask: u32 = 0x0f << offset;
        pub use super::access;
    ...
    #[doc = "SI messaging write domain This is the domain attribute setting used when NETC writes PSI-VSI message during partition copy"]
    ...
    #[doc = "SI messaging read data cache type This is the cache attribute setting used when NETC reads PSI-VSI message from memory during partition copy"]
    pub mod MSG_RDCACHE {
        pub const offset: u32 = 16;
        pub const mask: u32 = 0x0f << offset;
        pub use super::access;
    ...
    #[doc = "SI messaging read data domain This is the domain attribute setting used when NETC reads PSI-VSI message from memory during partition copy"]
    ...
    #[doc = "SI messaging read data snoop See table above for valid settings."]
    pub mod MSG_RDSNP {
        pub const offset: u32 = 22;
        pub const mask: u32 = 0x01 << offset;
        pub use super::access;
...
pub mod PSIMSGRR {
    pub use crate::RW as access;
    #[doc = "Message received from VSI a When this bit is set, a message is available at address PSIVaMSGRCVAR0/1 from VSI a"]
    pub mod MR1 {
        pub const offset: u32 = 1;
        pub const mask: u32 = 0x01 << offset;
        pub use super::access;
...
pub mod PSIMSGSR {
    pub use crate::RW as access;
    #[doc = "Message sent to VSI a When this bit is set (b1), from a clear state (b0), the message code provided in the MC field will be sent to the VSI"]
    pub mod MS1 {
        pub const offset: u32 = 1;
        pub const mask: u32 = 0x01 << offset;
        pub use super::access;
    ...
    #[doc = "Message code This field provides a user defined 16-bit message value"]
    pub mod MC {
        pub const offset: u32 = 16;
        pub const mask: u32 = 0xffff << offset;
        pub use super::access;
...
#[doc = "PSI VSI 1 message receive address register 0"]
pub mod PSIV1MSGRCVAR0 {
    pub use crate::RW as access;
    #[doc = "Message size Size of message as a multiple of 32 bytes copied from VSIMSGSNDAR0\\[MSIZE\\]"]
    pub mod MSIZE {
        pub const offset: u32 = 0;
    ...
    #[doc = "Message address low Lower address bits 31-6 of message received."]
    pub mod ADDRL {
        pub const offset: u32 = 6;
...
pub mod PSIIER {
    pub use crate::RW as access;
    #[doc = "Message receive interrupt enable, initiated by VSI n 0 Disabled 1 Enabled"]
    pub mod MR1IE {
        pub const offset: u32 = 1;
        pub const mask: u32 = 0x01 << offset;
        pub use super::access;
    ...
    #[doc = "Function level reset interrupt enable, initiated by VSI n 0 Disabled 1 Enabled"]
    pub mod FLR1IE {
...
pub mod PSIIDR {
    ...
    #[doc = "Message received from VSI n 0 No message received 1 Message received"]
    pub mod MR1 {
        pub const offset: u32 = 1;
        pub const mask: u32 = 0x01 << offset;
        pub use super::access;
    ...
    #[doc = "Function level reset of VF initiated by VSI n 0 No reset 1 Reset"]
    pub mod FLR1 {
        pub const offset: u32 = 17;
        pub const mask: u32 = 0x01 << offset;
        pub use super::access;
