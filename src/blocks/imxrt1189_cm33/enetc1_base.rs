...
pub struct RegisterBlock {
    ...
    pub PTCTSDR: [u32; 8usize],
    _reserved13: [u8; 0x0450],
    #[doc = "Switch management capability register"]
    pub SMCAPR: u32,
    _reserved14: [u8; 0x7c],
    #[doc = "Switch management host reason a receive BD ring mapping register"]
    pub SMHRBDRMR: [u32; 15usize],
    _reserved15: [u8; 0x1744],
    ...
    pub PSI0VHFR1: u32,
    _reserved20: [u8; 0x18],
    #[doc = "Port station interface 1 primary MAC address register 0"]
    pub PSI1PMAR0: u32,
    #[doc = "Port station interface 1 primary MAC address register 1"]
    pub PSI1PMAR1: u32,
    #[doc = "Port station interface 1 VLAN register"]
    pub PSI1VLANR: u32,
    _reserved21: [u8; 0x04],
    #[doc = "Port station interface 1 configuration register 0"]
    pub PSI1CFGR0: u32,
    #[doc = "Port station interface 1 configuration register 1"]
    pub PSI1CFGR1: u32,
    #[doc = "Port station interface 1 configuration register 2"]
    pub PSI1CFGR2: u32,
    _reserved22: [u8; 0x14],
    #[doc = "Port station interface 1 VSI MAC address filtering configuration register"]
    pub PSI1VMAFCFGR: u32,
    #[doc = "Port station interface 1 VLAN filtering configuration register"]
    pub PSI1VLANFCFGR: u32,
    _reserved23: [u8; 0x18],
    #[doc = "Port station interface 1 unicast MAC hash filter register 0"]
    pub PSI1UMHFR0: u32,
    #[doc = "Port station interface 1 unicast MAC hash filter register 1"]
    pub PSI1UMHFR1: u32,
    #[doc = "Port station interface 1 multicast MAC hash filter register 0"]
    pub PSI1MMHFR0: u32,
    #[doc = "Port station interface 1 multicast MAC hash filter register 1"]
    pub PSI1MMHFR1: u32,
    #[doc = "Port station interface 1 VLAN hash filter register 0"]
    pub PSI1VHFR0: u32,
    #[doc = "Port station interface 1 VLAN hash filter register 1"]
    pub PSI1VHFR1: u32,
}
#[doc = "ENETC capability register 0"]
pub mod ECAPR0 {
...
pub mod PMR {
    ...
    #[doc = "Enable station interface 1"]
    pub mod SI1EN {
...
pub mod PSIPMMR {
    ...
    #[doc = "SI 1 MAC unicast promiscuous"]
    pub mod SI1_MAC_UP {
        pub const offset: u32 = 1;
        pub const mask: u32 = 0x01 << offset;
        pub use crate::RW as access;
    ...
    #[doc = "SI 1 MAC multicast promiscuous"]
    pub mod SI1_MAC_MP {
        pub const offset: u32 = 17;
        pub const mask: u32 = 0x01 << offset;
        pub use crate::RW as access;
...
pub mod PSIPVMR {
    ...
    #[doc = "SI 1 VLAN promiscuous. This field specifies if SI 1 qualifies for the reception of all VLAN tags."]
    pub mod SI1_VLAN_P {
        pub const offset: u32 = 1;
        pub const mask: u32 = 0x01 << offset;
        pub use crate::RW as access;
        #[doc(hidden)]
        pub mod vals {
            #[doc = "SI 1 does not qualify for the reception of all VLAN tags"]
            pub const NOT_QUALIFY: u32 = 0;
            #[doc = "SI 1 does qualify for the reception of all VLAN tags"]
            pub const QUALIFY: u32 = 0x01;
        }
        #[doc(inline)]
        pub use vals::*;
    ...
    #[doc = "SI 1 Untagged frames (no VLAN) accepted"]
    pub mod SI1_VLAN_UTA {
        pub const offset: u32 = 17;
        pub const mask: u32 = 0x01 << offset;
        pub use crate::RW as access;
        #[doc(hidden)]
...
pub mod SMHRBDRMR {
    pub use crate::RW as access;
    #[doc = "Switch management (non-zero) host reason is directed to this receive BD ring"]
    pub mod RXBDR {
        pub const offset: u32 = 0;
...
pub mod PSI1CFGR1 {
    pub use crate::RW as access;
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 0 to set transmit traffic class."]
    pub mod TC0_MAP {
        pub const offset: u32 = 0;
        pub const mask: u32 = 0x07 << offset;
        pub use super::access;
    ...
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 1 to set transmit traffic class."]
    pub mod TC1_MAP {
        pub const offset: u32 = 4;
        pub const mask: u32 = 0x07 << offset;
        pub use super::access;
    ...
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 2 to set transmit traffic class."]
    pub mod TC2_MAP {
        pub const offset: u32 = 8;
        pub const mask: u32 = 0x07 << offset;
        pub use super::access;
    ...
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 3 to set transmit traffic class."]
    pub mod TC3_MAP {
        pub const offset: u32 = 12;
        pub const mask: u32 = 0x07 << offset;
        pub use super::access;
    ...
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 4 to set transmit traffic class."]
    pub mod TC4_MAP {
        pub const offset: u32 = 16;
        pub const mask: u32 = 0x07 << offset;
        pub use super::access;
    ...
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 5 to set transmit traffic class."]
    pub mod TC5_MAP {
        pub const offset: u32 = 20;
        pub const mask: u32 = 0x07 << offset;
        pub use super::access;
    ...
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 6 to set transmit traffic class."]
    pub mod TC6_MAP {
        pub const offset: u32 = 24;
        pub const mask: u32 = 0x07 << offset;
        pub use super::access;
    ...
    #[doc = "Traffic class mapping from PRIO2TCMR0 Maps the VSI traffic class 7 to set transmit traffic class."]
    pub mod TC7_MAP {
        pub const offset: u32 = 28;
        pub const mask: u32 = 0x07 << offset;
        pub use super::access;
