...
pub struct RegisterBlock {
    ...
    pub PCI_CFH_INT_LINE: u8,
    #[doc = "PCI interrupt pin register"]
    pub PCI_CFH_INT_PIN: u8,
    _reserved4: [u8; 0x02],
    ...
    pub PCI_CFC_PCIE_ROOT_CTL: u16,
    _reserved7: [u8; 0x02],
    #[doc = "PCI PCIe root status register"]
    pub PCI_CFC_PCIE_ROOT_STAT: u32,
    _reserved8: [u8; 0x1c],
