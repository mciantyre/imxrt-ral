...
pub struct RegisterBlock {
    #[doc = "CM33_IRQ_MASK0"]
    pub CM33_IRQ_MASK0: u32,
    #[doc = "CM33 IRQ MASK1"]
    pub CM33_IRQ_MASK1: u32,
    #[doc = "CM33_IRQ_MASK2"]
    pub CM33_IRQ_MASK2: u32,
    #[doc = "CM33_IRQ_MASK3"]
    pub CM33_IRQ_MASK3: u32,
    #[doc = "CM33_IRQ_MASK4"]
    pub CM33_IRQ_MASK4: u32,
    #[doc = "CM33_IRQ_MASK5"]
    pub CM33_IRQ_MASK5: u32,
    #[doc = "CM33_IRQ_MASK6"]
    pub CM33_IRQ_MASK6: u32,
    #[doc = "CM33_IRQ_MASK7"]
    pub CM33_IRQ_MASK7: u32,
    #[doc = "CM7_IRQ_MASK0"]
    pub CM7_IRQ_MASK0: u32,
    #[doc = "CM7_IRQ_MASK1"]
    pub CM7_IRQ_MASK1: u32,
    #[doc = "CM7_IRQ_MASK2"]
    pub CM7_IRQ_MASK2: u32,
    #[doc = "CM7_IRQ_MASK3"]
    pub CM7_IRQ_MASK3: u32,
    #[doc = "CM7_IRQ_MASK4"]
    pub CM7_IRQ_MASK4: u32,
    #[doc = "CM7_IRQ_MASK5"]
    pub CM7_IRQ_MASK5: u32,
    #[doc = "CM7_IRQ_MASK6"]
    pub CM7_IRQ_MASK6: u32,
    #[doc = "CM7_IRQ_MASK7"]
    pub CM7_IRQ_MASK7: u32,
    _reserved0: [u8; 0x18],
    #[doc = "EdgeLock reset request mask"]
    pub EDGELOCK_RESET_REQ_MASK: u32,
    #[doc = "EdgeLock IRQ request mask"]
    pub EDGELOCK_IRQ_MASK: u32,
    #[doc = "M33 Configuration"]
    pub M33_CFG: u32,
    #[doc = "M33 INITSVTOR"]
    pub M33_INITSVTOR: u32,
    #[doc = "M33 INITNSVTOR"]
    pub M33_INITNSVTOR: u32,
    _reserved1: [u8; 0x14],
    #[doc = "M7 Configuration"]
    pub M7_CFG: u32,
    _reserved2: [u8; 0x0c],
    #[doc = "AXBS_AON_CTRL"]
    pub AXBS_AON_CTRL: u32,
    _reserved3: [u8; 0x6c],
    #[doc = "DAP Access Sticky Bit"]
    pub DAP_ACCESS_STKYBIT: u32,
    _reserved4: [u8; 0x0c],
    #[doc = "Low power handshake enable"]
    pub LP_HANDSHAKE: u32,
    #[doc = "EdgeLock halt status"]
    pub EDGELOCK_HALT_ST: u32,
    _reserved5: [u8; 0x08],
    #[doc = "ECC memory hardware initialization"]
    pub ECC_MEM_INIT: u32,
    _reserved6: [u8; 0x24],
    #[doc = "IOMUXC domain configure"]
    pub IOMUXC_DOMAIN_CFG: u32,
    #[doc = "IOMUXC_AON domain configure"]
    pub IOMUXC_AON_DOMAIN_CFG: u32,
    _reserved7: [u8; 0x04],
    #[doc = "NMI control"]
    pub NMI_CTRL: u32,
    #[doc = "s401_ipi_noclk_ref1 clear control"]
    pub S401_NOCLK_CLEAR_CTRL: u32,
}
#[doc = "CM33_IRQ_MASK0"]
