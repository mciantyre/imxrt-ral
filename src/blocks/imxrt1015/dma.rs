...
pub struct RegisterBlock {
    ...
    pub DCHPRI28: u8,
    _reserved7: [u8; 0x20],
    #[doc = "Channel n Master ID Register"]
    pub DCHMID: [u8; 32usize],
    _reserved8: [u8; 0x0ea0],
...
pub mod DCHMID {
    ...
    pub mod EMI {
        ...
        pub mod vals {
            ...
            pub const EMI_0: u8 = 0;
            #[doc = "Master ID replication is enabled"]
            pub const EMI_1: u8 = 0x01;
        }
        #[doc(inline)]
        pub use vals::*;
    }
