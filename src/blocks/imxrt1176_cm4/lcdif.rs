...
pub mod VDCTRL0 {
    ...
    #[doc = "0 means the VSYNC signal is an output, 1 means it is an input"]
    pub mod VSYNC_OEB {
        ...
        #[doc(hidden)]
        pub mod vals {
            #[doc = "The VSYNC pin is in the output mode and the VSYNC signal has to be generated by the LCDIF block."]
            pub const VSYNC_OUTPUT: u32 = 0;
            #[doc = "The VSYNC pin is in the input mode and the LCD controller sends the VSYNC signal to the block."]
            pub const VSYNC_INPUT: u32 = 0x01;
        }
        #[doc(inline)]
        pub use vals::*;
    }
