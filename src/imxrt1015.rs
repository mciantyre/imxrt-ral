...
pub mod adc {
    ...
    pub const ADC: *mut RegisterBlock = 0x400c_4000 as *mut RegisterBlock;
    #[path = "blocks/imxrt1015/adc.rs"]
    mod blocks;
    pub use blocks::*;
...
pub mod adc_etc {
    ...
    #[path = "blocks/imxrt1015/adc_etc.rs"]
    mod blocks;
    pub use blocks::*;
    pub type Instance<const N: u8> = crate::Instance<RegisterBlock, N>;
...
pub mod enc1 {
    ...
    #[path = "blocks/imxrt1015/enc1.rs"]
    mod blocks;
    pub use blocks::*;
    pub type Instance<const N: u8> = crate::Instance<RegisterBlock, N>;
    pub type ENC1 = Instance<{ crate::SOLE_INSTANCE }>;
    ...
    #[doc = r" Returns the instance number `N` for a peripheral instance."]
    pub fn number(rb: *const RegisterBlock) -> Option<u8> {
        core::ptr::eq(rb, ENC1).then_some(0)
    }
}
#[path = "."]
pub mod ewm {
...
pub mod iomuxc {
    ...
    #[path = "blocks/imxrt1015/iomuxc.rs"]
    mod blocks;
    pub use blocks::*;
    pub type Instance<const N: u8> = crate::Instance<RegisterBlock, N>;
...
pub mod iomuxc_gpr {
    ...
    #[path = "blocks/imxrt1015/iomuxc_gpr.rs"]
    mod blocks;
    pub use blocks::*;
    pub type Instance<const N: u8> = crate::Instance<RegisterBlock, N>;
...
pub mod iomuxc_snvs {
    ...
    #[path = "blocks/imxrt1015/iomuxc_snvs.rs"]
    mod blocks;
    pub use blocks::*;
    pub type Instance<const N: u8> = crate::Instance<RegisterBlock, N>;
...
pub mod ocotp {
    ...
    #[path = "blocks/imxrt1015/ocotp.rs"]
    mod blocks;
    pub use blocks::*;
    pub type Instance<const N: u8> = crate::Instance<RegisterBlock, N>;
...
pub mod pwm {
    #[doc = "PWM"]
    pub const PWM: *mut RegisterBlock = 0x403d_c000 as *mut RegisterBlock;
    #[path = "blocks/imxrt1015/pwm.rs"]
    mod blocks;
    pub use blocks::*;
    pub type Instance<const N: u8> = crate::Instance<RegisterBlock, N>;
...
pub mod tmr1 {
    ...
    #[path = "blocks/imxrt1015/tmr1.rs"]
    mod blocks;
    pub use blocks::*;
    pub type Instance<const N: u8> = crate::Instance<RegisterBlock, N>;
    pub type TMR1 = Instance<{ crate::SOLE_INSTANCE }>;
    ...
    #[doc = r" Returns the instance number `N` for a peripheral instance."]
    pub fn number(rb: *const RegisterBlock) -> Option<u8> {
        core::ptr::eq(rb, TMR1).then_some(0)
    }
}
#[path = "."]
pub mod trng {
