...
pub use crate::imxrt106::peripherals::rtwdog::Instance;
pub use crate::imxrt106::peripherals::rtwdog::{RegisterBlock, ResetValues};

pub use crate::imxrt106::peripherals::rtwdog::{CNT, CS, TOVAL, WIN};
