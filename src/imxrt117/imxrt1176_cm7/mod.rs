//! Register access layer for imxrt1176_cm7
...
pub struct Peripherals {
    ...
    pub DMAMUX0: dmamux0::Instance<0>,
    ...
    pub SystemControl: systemcontrol::Instance<0>,
    pub NVIC: nvic::Instance<0>,
    pub CM7_MCM: cm7_mcm::Instance<0>,
}
