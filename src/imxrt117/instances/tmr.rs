...
pub use crate::imxrt117::peripherals::tmr::Instance;
pub use crate::imxrt117::peripherals::tmr::{RegisterBlock, ResetValues};

pub use crate::imxrt117::peripherals::tmr::{
...
pub const TMR1: *const RegisterBlock = 0x4015c000 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const TMR2: *const RegisterBlock = 0x40160000 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const TMR3: *const RegisterBlock = 0x40164000 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const TMR4: *const RegisterBlock = 0x40168000 as *const _;
