...
pub use crate::imxrt117::peripherals::ewm::Instance;
pub use crate::imxrt117::peripherals::ewm::{RegisterBlock, ResetValues};

pub use crate::imxrt117::peripherals::ewm::{CLKCTRL, CLKPRESCALER, CMPH, CMPL, CTRL, SERV};
...
pub const EWM: *const RegisterBlock = 0x4002c000 as *const _;
