...
pub use crate::imxrt117::peripherals::enet::Instance;
pub use crate::imxrt117::peripherals::enet::{RegisterBlock, ResetValues};

pub use crate::imxrt117::peripherals::enet::{
    ...
    RMON_R_P64, RMON_R_P65TO127, RMON_R_PACKETS, RMON_R_P_GTE2048, RMON_R_UNDERSIZE, RMON_T_BC_PKT,
    RMON_T_COL, RMON_T_CRC_ALIGN, RMON_T_FRAG, RMON_T_JAB, RMON_T_MC_PKT, RMON_T_OCTETS,
    RMON_T_OVERSIZE, RMON_T_P1024TO2047, RMON_T_P128TO255, RMON_T_P256TO511, RMON_T_P512TO1023,
    RMON_T_P64, RMON_T_P65TO127, RMON_T_PACKETS, RMON_T_P_GTE2048, RMON_T_UNDERSIZE, RSEM, RSFL,
    RXIC0, RXIC1, RXIC2, TACC, TAEM, TAFL, TCCR0, TCCR1, TCCR2, TCCR3, TCR, TCSR0, TCSR1, TCSR2,
    TCSR3, TDAR, TDSR, TFWR, TGSR, TIPG, TSEM, TXIC0, TXIC1, TXIC2,
};
...
pub const ENET: *const RegisterBlock = 0x40424000 as *const _;
