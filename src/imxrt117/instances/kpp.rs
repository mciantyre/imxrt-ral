...
pub use crate::imxrt117::peripherals::kpp::Instance;
pub use crate::imxrt117::peripherals::kpp::{RegisterBlock, ResetValues};

pub use crate::imxrt117::peripherals::kpp::{KDDR, KPCR, KPDR, KPSR};
...
pub const KPP: *const RegisterBlock = 0x400e0000 as *const _;
