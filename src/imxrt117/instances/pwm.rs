...
pub use crate::imxrt117::peripherals::pwm::Instance;
pub use crate::imxrt117::peripherals::pwm::{RegisterBlock, ResetValues};

pub use crate::imxrt117::peripherals::pwm::{
    ...
    SMDISMAP0_0, SMDISMAP0_1, SMDISMAP0_2, SMDISMAP0_3, SMDMAEN_0, SMDMAEN_1, SMDMAEN_2, SMDMAEN_3,
    SMDTCNT0_0, SMDTCNT0_1, SMDTCNT0_2, SMDTCNT0_3, SMDTCNT1_0, SMDTCNT1_1, SMDTCNT1_2, SMDTCNT1_3,
    SMFRACVAL1_0, SMFRACVAL1_1, SMFRACVAL1_2, SMFRACVAL1_3, SMFRACVAL2_0, SMFRACVAL2_1,
    SMFRACVAL2_2, SMFRACVAL2_3, SMFRACVAL3_0, SMFRACVAL3_1, SMFRACVAL3_2, SMFRACVAL3_3,
    SMFRACVAL4_0, SMFRACVAL4_1, SMFRACVAL4_2, SMFRACVAL4_3, SMFRACVAL5_0, SMFRACVAL5_1,
    SMFRACVAL5_2, SMFRACVAL5_3, SMFRCTRL_0, SMFRCTRL_1, SMFRCTRL_2, SMFRCTRL_3, SMINIT_0, SMINIT_1,
    SMINIT_2, SMINIT_3, SMINTEN_0, SMINTEN_1, SMINTEN_2, SMINTEN_3, SMOCTRL_0, SMOCTRL_1,
    SMOCTRL_2, SMOCTRL_3, SMSTS_0, SMSTS_1, SMSTS_2, SMSTS_3, SMTCTRL_0, SMTCTRL_1, SMTCTRL_2,
    SMTCTRL_3, SMVAL0_0, SMVAL0_1, SMVAL0_2, SMVAL0_3, SMVAL1_0, SMVAL1_1, SMVAL1_2, SMVAL1_3,
    SMVAL2_0, SMVAL2_1, SMVAL2_2, SMVAL2_3, SMVAL3_0, SMVAL3_1, SMVAL3_2, SMVAL3_3, SMVAL4_0,
    SMVAL4_1, SMVAL4_2, SMVAL4_3, SMVAL5_0, SMVAL5_1, SMVAL5_2, SMVAL5_3, SWCOUT,
};
...
pub const PWM1: *const RegisterBlock = 0x4018c000 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const PWM2: *const RegisterBlock = 0x40190000 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const PWM3: *const RegisterBlock = 0x40194000 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const PWM4: *const RegisterBlock = 0x40198000 as *const _;
