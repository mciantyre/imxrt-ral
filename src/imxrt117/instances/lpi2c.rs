...
pub use crate::imxrt117::peripherals::lpi2c::Instance;
pub use crate::imxrt117::peripherals::lpi2c::{RegisterBlock, ResetValues};

pub use crate::imxrt117::peripherals::lpi2c::{
...
pub const LPI2C1: *const RegisterBlock = 0x40104000 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const LPI2C2: *const RegisterBlock = 0x40108000 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const LPI2C3: *const RegisterBlock = 0x4010c000 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const LPI2C4: *const RegisterBlock = 0x40110000 as *const _;

/// The LPI2C5 peripheral instance.
#[cfg(not(feature = "doc"))]
...
#[allow(private_no_mangle_statics)]
#[no_mangle]
static LPI2C5_TAKEN: AtomicBool = AtomicBool::new(false);

/// Access functions for the LPI2C5 peripheral instance
#[cfg(not(feature = "nosync"))]
impl LPI2C5 {
    const INSTANCE: Self = Self {
        addr: 0x40c34000,
        #[cfg(not(feature = "doc"))]
        intrs: &[crate::interrupt::LPI2C5],
    };

    /// Reset values for each field in LPI2C5
    pub const reset: ResetValues = ResetValues {
        VERID: 0x01010003,
        PARAM: 0x00000202,
        MCR: 0x00000000,
    ...
    #[inline]
    pub fn take() -> Option<Self> {
        let taken = LPI2C5_TAKEN.swap(true, Ordering::SeqCst);
        if taken {
            None
        } else {
            Some(Self::INSTANCE)
    ...
    /// Release exclusive access to LPI2C5
    ///
    /// This function allows you to return an `Instance` so that it
    /// is available to `take()` again. This function will panic if
    /// you return a different `Instance` or if this instance is not
    ...
    #[inline]
    pub fn release(_: Self) {
        let taken = LPI2C5_TAKEN.swap(false, Ordering::SeqCst);
        assert!(taken, "Released a peripheral which was not taken");
    }

    /// Unsafely steal LPI2C5
    ///
    /// This function is similar to take() but forcibly takes the
    /// Instance, marking it as taken irregardless of its previous
    /// state.
    #[inline]
    pub unsafe fn steal() -> Self {
        LPI2C5_TAKEN.store(true, Ordering::SeqCst);
        Self::INSTANCE
    }
}

impl LPI2C5 {
    /// The interrupts associated with LPI2C5
    #[cfg(not(feature = "doc"))]
    pub const INTERRUPTS: [crate::Interrupt; 1] = [crate::interrupt::LPI2C5];
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const LPI2C5: *const RegisterBlock = 0x40c34000 as *const _;

/// The LPI2C6 peripheral instance.
#[cfg(not(feature = "doc"))]
...
#[allow(private_no_mangle_statics)]
#[no_mangle]
static LPI2C6_TAKEN: AtomicBool = AtomicBool::new(false);

/// Access functions for the LPI2C6 peripheral instance
#[cfg(not(feature = "nosync"))]
impl LPI2C6 {
    const INSTANCE: Self = Self {
        addr: 0x40c38000,
        #[cfg(not(feature = "doc"))]
        intrs: &[crate::interrupt::LPI2C6],
    };

    /// Reset values for each field in LPI2C6
    pub const reset: ResetValues = ResetValues {
        VERID: 0x01010003,
        PARAM: 0x00000202,
        MCR: 0x00000000,
    ...
    #[inline]
    pub fn take() -> Option<Self> {
        let taken = LPI2C6_TAKEN.swap(true, Ordering::SeqCst);
        if taken {
            None
        } else {
            Some(Self::INSTANCE)
    ...
    /// Release exclusive access to LPI2C6
    ///
    /// This function allows you to return an `Instance` so that it
    /// is available to `take()` again. This function will panic if
    /// you return a different `Instance` or if this instance is not
    ...
    #[inline]
    pub fn release(_: Self) {
        let taken = LPI2C6_TAKEN.swap(false, Ordering::SeqCst);
        assert!(taken, "Released a peripheral which was not taken");
    }

    /// Unsafely steal LPI2C6
    ///
    /// This function is similar to take() but forcibly takes the
    /// Instance, marking it as taken irregardless of its previous
    /// state.
    #[inline]
    pub unsafe fn steal() -> Self {
        LPI2C6_TAKEN.store(true, Ordering::SeqCst);
        Self::INSTANCE
    }
}

impl LPI2C6 {
    /// The interrupts associated with LPI2C6
    #[cfg(not(feature = "doc"))]
    pub const INTERRUPTS: [crate::Interrupt; 1] = [crate::interrupt::LPI2C6];
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const LPI2C6: *const RegisterBlock = 0x40c38000 as *const _;
