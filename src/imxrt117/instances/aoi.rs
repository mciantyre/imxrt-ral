...
pub use crate::imxrt117::peripherals::aoi::Instance;
pub use crate::imxrt117::peripherals::aoi::{RegisterBlock, ResetValues};

pub use crate::imxrt117::peripherals::aoi::{
...
pub const AOI1: *const RegisterBlock = 0x400b8000 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const AOI2: *const RegisterBlock = 0x400bc000 as *const _;
