...
pub use crate::imxrt117::peripherals::sai1::Instance;
pub use crate::imxrt117::peripherals::sai1::{RegisterBlock, ResetValues};

pub use crate::imxrt117::peripherals::sai1::{
...
pub const SAI1: *const RegisterBlock = 0x40404000 as *const _;
