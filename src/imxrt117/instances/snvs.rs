...
pub use crate::imxrt117::peripherals::snvs::Instance;
pub use crate::imxrt117::peripherals::snvs::{RegisterBlock, ResetValues};

pub use crate::imxrt117::peripherals::snvs::{
    ...
    HPVIDR1, HPVIDR2, LPAT1CR, LPAT2CR, LPAT3CR, LPAT4CR, LPAT5CR, LPATCLKR, LPATCTLR, LPATRC1R,
    LPATRC2R, LPCR, LPGPR0, LPGPR1, LPGPR2, LPGPR3, LPLR, LPLVDR, LPMKCR, LPSMCLR, LPSMCMR, LPSR,
    LPSRTCLR, LPSRTCMR, LPSVCR, LPTAR, LPTDC2R, LPTDCR, LPTDSR, LPTGF1CR, LPTGF2CR, LPTGFCR,
    LPZMKR0, LPZMKR1, LPZMKR2, LPZMKR3, LPZMKR4, LPZMKR5, LPZMKR6, LPZMKR7,
};
...
pub const SNVS: *const RegisterBlock = 0x40c90000 as *const _;
