...
pub use crate::imxrt117::peripherals::spdif::Instance;
pub use crate::imxrt117::peripherals::spdif::{RegisterBlock, ResetValues};

pub use crate::imxrt117::peripherals::spdif::{
...
pub const SPDIF: *const RegisterBlock = 0x40400000 as *const _;
