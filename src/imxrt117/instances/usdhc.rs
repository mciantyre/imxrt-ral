...
pub use crate::imxrt117::peripherals::usdhc::Instance;
pub use crate::imxrt117::peripherals::usdhc::{RegisterBlock, ResetValues};

pub use crate::imxrt117::peripherals::usdhc::{
    ...
    MMC_BOOT, PRES_STATE, PROT_CTRL, STROBE_DLL_CTRL, STROBE_DLL_STATUS, SYS_CTRL, TUNING_CTRL,
    VEND_SPEC, VEND_SPEC2, WTMK_LVL,
};
...
impl USDHC1 {
    ...
    pub const reset: ResetValues = ResetValues {
        ...
        STROBE_DLL_CTRL: 0x00000000,
        STROBE_DLL_STATUS: 0x00000200,
        VEND_SPEC: 0x30007809,
        MMC_BOOT: 0x00000000,
        VEND_SPEC2: 0x00019006,
...
pub const USDHC1: *const RegisterBlock = 0x40418000 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const USDHC2: *const RegisterBlock = 0x4041c000 as *const _;
