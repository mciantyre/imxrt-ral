...
pub use crate::imxrt117::peripherals::enc::Instance;
pub use crate::imxrt117::peripherals::enc::{RegisterBlock, ResetValues};

pub use crate::imxrt117::peripherals::enc::{
    CTRL, CTRL2, CTRL3, FILT, IMR, LASTEDGE, LASTEDGEH, LCOMP, LINIT, LMOD, LPOS, LPOSH, POSD,
    POSDH, POSDPER, POSDPERBFR, POSDPERH, REV, REVH, TST, UCOMP, UINIT, UMOD, UPOS, UPOSH, WTR,
};
...
impl ENC1 {
    ...
    pub const reset: ResetValues = ResetValues {
        ...
        LCOMP: 0x0000FFFF,
        LASTEDGE: 0x0000FFFF,
        LASTEDGEH: 0x0000FFFF,
        POSDPER: 0x0000FFFF,
        POSDPERBFR: 0x0000FFFF,
        POSDPERH: 0x0000FFFF,
        CTRL3: 0x00000000,
    };
...
pub const ENC1: *const RegisterBlock = 0x40174000 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const ENC2: *const RegisterBlock = 0x40178000 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const ENC3: *const RegisterBlock = 0x4017c000 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const ENC4: *const RegisterBlock = 0x40180000 as *const _;
