...
pub use crate::imxrt117::peripherals::wdog::Instance;
pub use crate::imxrt117::peripherals::wdog::{RegisterBlock, ResetValues};

pub use crate::imxrt117::peripherals::wdog::{WCR, WICR, WMCR, WRSR, WSR};
...
pub const WDOG1: *const RegisterBlock = 0x40030000 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const WDOG2: *const RegisterBlock = 0x40034000 as *const _;
