...
pub use crate::imxrt117::peripherals::lcdif::Instance;
pub use crate::imxrt117::peripherals::lcdif::{RegisterBlock, ResetValues};

pub use crate::imxrt117::peripherals::lcdif::{
    ...
    STAT, THRES, TRANSFER_COUNT, VDCTRL0, VDCTRL0_CLR, VDCTRL0_SET, VDCTRL0_TOG, VDCTRL1, VDCTRL2,
    VDCTRL3, VDCTRL4,
};
...
impl LCDIF {
    ...
    #[cfg(not(feature = "doc"))]
    pub const INTERRUPTS: [crate::Interrupt; 1] = [crate::interrupt::eLCDIF];
...
pub const LCDIF: *const RegisterBlock = 0x40804000 as *const _;
