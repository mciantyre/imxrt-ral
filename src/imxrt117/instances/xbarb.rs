...
pub use crate::imxrt117::peripherals::xbarb::Instance;
pub use crate::imxrt117::peripherals::xbarb::{RegisterBlock, ResetValues};

pub use crate::imxrt117::peripherals::xbarb::{SEL0, SEL1, SEL2, SEL3, SEL4, SEL5, SEL6, SEL7};
...
pub const XBARB2: *const RegisterBlock = 0x40040000 as *const _;
...
/// This constant is provided for ease of use in unsafe code: you can
/// simply call for example `write_reg!(gpio, GPIOA, ODR, 1);`.
pub const XBARB3: *const RegisterBlock = 0x40044000 as *const _;
