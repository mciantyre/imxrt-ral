...
pub mod CTRL0 {
    ...
    pub mod DIR {
        ...
        pub mod RW {
            ...
            /// 0b0: Count up.
            pub const COUNTUP: u16 = 0b0;

            /// 0b1: Count down.
            pub const COUNTDOWN: u16 = 0b1;
        }
    }
    ...
    pub mod LENGTH {
        ...
        pub mod RW {
            ...
            pub const UNTIL_ROLLOVER: u16 = 0b0;
            ...
            pub const UNTIL_COMPARE: u16 = 0b1;
        }
    }
    ...
    pub mod SCS {
        ...
        pub mod RW {
            ...
            pub const COUNTER0_IN: u16 = 0b00;

            /// 0b01: Counter 1 input pin
            pub const COUNTER1_IN: u16 = 0b01;

            /// 0b10: Counter 2 input pin
            pub const COUNTER2_IN: u16 = 0b10;

            /// 0b11: Counter 3 input pin
            pub const COUNTER3_IN: u16 = 0b11;
        }
    }
    ...
    pub mod PCS {
        ...
        pub mod RW {
            ...
            pub const COUNTER0_IN: u16 = 0b0000;

            /// 0b0001: Counter 1 input pin
            pub const COUNTER1_IN: u16 = 0b0001;

            /// 0b0010: Counter 2 input pin
            pub const COUNTER2_IN: u16 = 0b0010;

            /// 0b0011: Counter 3 input pin
            pub const COUNTER3_IN: u16 = 0b0011;

            /// 0b0100: Counter 0 output
            pub const COUNTER0_OUT: u16 = 0b0100;

            /// 0b0101: Counter 1 output
            pub const COUNTER1_OUT: u16 = 0b0101;

            /// 0b0110: Counter 2 output
            pub const COUNTER2_OUT: u16 = 0b0110;

            /// 0b0111: Counter 3 output
            pub const COUNTER3_OUT: u16 = 0b0111;

            /// 0b1000: IP bus clock divide by 1 prescaler
            pub const BUS_DIVBY1: u16 = 0b1000;

            /// 0b1001: IP bus clock divide by 2 prescaler
            pub const BUS_DIVBY2: u16 = 0b1001;

            /// 0b1010: IP bus clock divide by 4 prescaler
            pub const BUS_DIVBY4: u16 = 0b1010;

            /// 0b1011: IP bus clock divide by 8 prescaler
            pub const BUS_DIVBY8: u16 = 0b1011;

            /// 0b1100: IP bus clock divide by 16 prescaler
            pub const BUS_DIVBY16: u16 = 0b1100;

            /// 0b1101: IP bus clock divide by 32 prescaler
            pub const BUS_DIVBY32: u16 = 0b1101;

            /// 0b1110: IP bus clock divide by 64 prescaler
            pub const BUS_DIVBY64: u16 = 0b1110;

            /// 0b1111: IP bus clock divide by 128 prescaler
            pub const BUS_DIVBY128: u16 = 0b1111;
        }
    }
    ...
    pub mod CM {
        ...
        pub mod RW {
            ...
            pub const RISING_ONLY: u16 = 0b001;
...
pub mod CSCTRL0 {
    ...
    pub mod UP {
        ...
        pub mod RW {
            ...
            pub const DOWN: u16 = 0b0;

            /// 0b1: The last count was in the UP direction.
            pub const UP: u16 = 0b1;
        }
    }
...
pub mod ENBL {
    ...
    pub mod ENBL {
        ...
        pub mod RW {
            ...
            pub const DISABLE: u16 = 0b0000;

            /// 0b0001: Timer channel is enabled. (default)
            pub const ENABLE: u16 = 0b0001;
        }
    }
}
