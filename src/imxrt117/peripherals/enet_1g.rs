...
/// Transmit Interrupt Coalescing Register
pub mod TXIC1 {
    pub use super::TXIC0::ICCS;
    pub use super::TXIC0::ICEN;
    pub use super::TXIC0::ICFT;
    pub use super::TXIC0::ICTT;
}
...
pub mod TFWR {
    ...
    pub mod TFWR {
        ...
        pub mod RW {
            ...
            pub const VAL64_0: u32 = 0b000000;

            /// 0b000001: 64 bytes written.
            pub const VAL64_1: u32 = 0b000001;

            /// 0b000010: 128 bytes written.
            pub const VAL128: u32 = 0b000010;

            /// 0b000011: 192 bytes written.
            pub const VAL192: u32 = 0b000011;

            /// 0b111111: 4032 bytes written.
            pub const VAL4032: u32 = 0b111111;
        }
    }
...
pub mod RDSR2 {
    pub use super::RDSR1::R_DES_START;
}

/// Transmit Buffer Descriptor Ring 2 Start Register
pub mod TDSR2 {
    pub use super::TDSR1::X_DES_START;
}

/// Maximum Receive Buffer Size Register - Ring 2
pub mod MRBR2 {
    pub use super::MRBR1::R_BUF_SIZE;
}
...
/// Receive Classification Match Register for Class n
pub mod RCMR2 {
    pub use super::RCMR1::CMP0;
    pub use super::RCMR1::CMP1;
    pub use super::RCMR1::CMP2;
    pub use super::RCMR1::CMP3;
    pub use super::RCMR1::MATCHEN;
}
...
/// DMA Class Based Configuration
pub mod DMACFG2 {
    pub use super::DMACFG1::CALC_NOIPG;
    pub use super::DMACFG1::DMA_CLASS_EN;
    pub use super::DMACFG1::IDLE_SLOPE;
}

/// Receive Descriptor Active Register - Ring 1
pub mod RDAR1 {
    pub use super::RDAR::RDAR;
}

/// Transmit Descriptor Active Register - Ring 1
pub mod TDAR1 {
    pub use super::TDAR::TDAR;
}
...
pub mod QOS {
    ...
    pub mod TX_SCHEME {
        ...
        pub mod RW {
            ...
            pub const CREDIT: u32 = 0b000;

            /// 0b001: Round-robin scheme
            pub const RR: u32 = 0b001;
        }
    }
...
pub struct RegisterBlock {
    ...
    /// Transmit Interrupt Coalescing Register
    pub TXIC0: RWRegister<u32>,

    /// Transmit Interrupt Coalescing Register
    pub TXIC1: RWRegister<u32>,

    /// Transmit Interrupt Coalescing Register
    pub TXIC2: RWRegister<u32>,

    _reserved9: [u32; 1],

    /// Receive Interrupt Coalescing Register
    pub RXIC0: RWRegister<u32>,

    /// Receive Interrupt Coalescing Register
    pub RXIC1: RWRegister<u32>,

    /// Receive Interrupt Coalescing Register
    pub RXIC2: RWRegister<u32>,
    ...
    /// Receive Descriptor Ring 1 Start Register
    pub RDSR1: RWRegister<u32>,

    /// Transmit Buffer Descriptor Ring 1 Start Register
    pub TDSR1: RWRegister<u32>,

    /// Maximum Receive Buffer Size Register - Ring 1
    pub MRBR1: RWRegister<u32>,

    /// Receive Descriptor Ring 2 Start Register
    pub RDSR2: RWRegister<u32>,

    /// Transmit Buffer Descriptor Ring 2 Start Register
    pub TDSR2: RWRegister<u32>,

    /// Maximum Receive Buffer Size Register - Ring 2
    pub MRBR2: RWRegister<u32>,
    ...
    /// Receive Classification Match Register for Class n
    pub RCMR1: RWRegister<u32>,

    /// Receive Classification Match Register for Class n
    pub RCMR2: RWRegister<u32>,

    _reserved16: [u32; 2],

    /// DMA Class Based Configuration
    pub DMACFG1: RWRegister<u32>,

    /// DMA Class Based Configuration
    pub DMACFG2: RWRegister<u32>,

    /// Receive Descriptor Active Register - Ring 1
    pub RDAR1: RWRegister<u32>,

    /// Transmit Descriptor Active Register - Ring 1
    pub TDAR1: RWRegister<u32>,

    /// Receive Descriptor Active Register - Ring 2
    pub RDAR2: RWRegister<u32>,

    /// Transmit Descriptor Active Register - Ring 2
    pub TDAR2: RWRegister<u32>,

    /// QOS Scheme
    pub QOS: RWRegister<u32>,
