...
pub mod OUTEN {
    ...
    pub mod PWMX_EN {
        ...
        pub mod RW {
            ...
            pub const DISABLED: u16 = 0b0000;

            /// 0b0001: PWM_X output enabled.
            pub const ENABLED: u16 = 0b0001;
        }
    }
...
pub mod MCTRL2 {
    ...
    pub mod MONPLL {
        ...
        pub mod RW {
            ...
            pub const NOTLOCKED_DO_NOT_MON_PLL: u16 = 0b00;
            ...
            pub const NOTLOCKED_MON_PLL: u16 = 0b01;
            ...
            pub const LOCKED_DO_NOT_MON_PLL: u16 = 0b10;
            ...
            pub const LOCKED_MON_PLL: u16 = 0b11;
        }
    }
}
...
pub mod FCTRL0 {
    ...
    pub mod FAUTO {
        ...
        pub mod RW {
            ...
            pub const AUTOMATIC: u16 = 0b0001;
        }
    }
...
pub mod FSTS0 {
    ...
    pub mod FFULL {
        ...
        pub mod RW {
            ...
            pub const PWM_OUTPUTS_NOT_REENABLED: u16 = 0b0000;

            /// 0b0001: PWM outputs are re-enabled at the start of a full cycle
            pub const PWM_OUTPUTS_REENABLED: u16 = 0b0001;
        }
    }
...
pub mod FTST0 {
    ...
    pub mod FTEST {
        ...
        pub mod RW {
            ...
            /// 0b0: No fault
            pub const NO_FAULT: u16 = 0b0;

            /// 0b1: Cause a simulated fault
            pub const FAULT: u16 = 0b1;
        }
    }
}
...
pub mod SMCTRL2_0 {
    ...
    pub mod INIT_SEL {
        ...
        pub mod RW {
            ...
            pub const MASTER_RELOAD: u16 = 0b01;
            ...
            pub const MASTER_SYNC: u16 = 0b10;

            /// 0b11: EXT_SYNC causes initialization.
            pub const EXT_SYNC: u16 = 0b11;
        }
    }
    ...
    pub mod INDEP {
        ...
        pub mod RW {
            ...
            pub const COMPLEMENTARY: u16 = 0b0;

            /// 0b1: PWM_A and PWM_B outputs are independent PWMs.
            pub const INDEPENDENT: u16 = 0b1;
        }
    }
...
pub mod SMCTRL_0 {
    ...
    pub mod LDMOD {
        ...
        pub mod RW {
            ...
            pub const NEXT_PWM_RELOAD: u16 = 0b0;
            ...
            pub const MTCTRL_LDOK_SET: u16 = 0b1;
        }
    }
    ...
    pub mod PRSC {
        ...
        pub mod RW {
            ...
            /// 0b000: Prescaler 1
            pub const ONE: u16 = 0b000;

            /// 0b001: Prescaler 2
            pub const TWO: u16 = 0b001;

            /// 0b010: Prescaler 4
            pub const FOUR: u16 = 0b010;

            /// 0b011: Prescaler 8
            pub const EIGHT: u16 = 0b011;

            /// 0b100: Prescaler 16
            pub const SIXTEEN: u16 = 0b100;

            /// 0b101: Prescaler 32
            pub const THIRTYTWO: u16 = 0b101;

            /// 0b110: Prescaler 64
            pub const SIXTYFOUR: u16 = 0b110;

            /// 0b111: Prescaler 128
            pub const HUNDREDTWENTYEIGHT: u16 = 0b111;
        }
    }
    ...
    pub mod COMPMODE {
        ...
        pub mod RW {
            ...
            pub const EQUAL_TO_OR_GREATER_THAN: u16 = 0b1;
        }
    }
...
pub mod SMSTS_0 {
    ...
    pub mod RF {
        ...
        pub mod RW {
            ...
            pub const NO_FLAG: u16 = 0b0;

            /// 0b1: New reload cycle since last STS\[RF\] clearing
            pub const FLAG: u16 = 0b1;
        }
    }
...
pub mod SMTCTRL_0 {
    ...
    pub mod OUT_TRIG_EN {
        ...
        pub mod RW {
            ...
            /// 0b000000: PWM_OUT_TRIG0 will set when the counter value matches the VAL0 value.
            pub const VAL0: u16 = 0b000000;
        }
    }
    ...
    pub mod PWBOT1 {
        ...
        pub mod RW {
            ...
            pub const PWM_OUT_TRIG1_SIGNAL: u16 = 0b0;

            /// 0b1: Route the PWMB output to the PWM_OUT_TRIG1 port.
            pub const PWMB_OUTPUT: u16 = 0b1;
        }
    }
    ...
    pub mod PWAOT0 {
        ...
        pub mod RW {
            ...
            pub const PWM_OUT_TRIG0_SIGNAL: u16 = 0b0;

            /// 0b1: Route the PWMA output to the PWM_OUT_TRIG0 port.
            pub const PWMA_OUTPUT: u16 = 0b1;
        }
    }
}
...
pub mod SMCAPTCTRLA_0 {
    ...
    pub mod ONESHOTA {
        ...
        pub mod RW {
            ...
            /// 0b0: Free Running
            pub const FREE_RUNNING: u16 = 0b0;

            /// 0b1: One Shot
            pub const ONE_SHOT: u16 = 0b1;
        }
    }
    ...
    pub mod EDGA0 {
        ...
        pub mod RW {
            ...
            pub const FALLING_EDGE: u16 = 0b01;

            /// 0b10: Capture rising edges
            pub const RISING_EDGE: u16 = 0b10;

            /// 0b11: Capture any edge
            pub const ANY_EDGE: u16 = 0b11;
        }
    }
    ...
    pub mod INP_SELA {
        ...
        pub mod RW {
            ...
            pub const PWM_A: u16 = 0b0;

            /// 0b1: Edge Counter
            pub const EDGE_COUNTER: u16 = 0b1;
        }
    }
