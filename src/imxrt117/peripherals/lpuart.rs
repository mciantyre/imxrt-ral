...
pub mod VERID {
    ...
    pub mod FEATURE {
        ...
        pub mod RW {
            ...
            pub const STANDARD: u32 = 0b0000000000000001;

            /// 0b0000000000000011: Standard feature set with MODEM/IrDA support.
            pub const MODEM: u32 = 0b0000000000000011;
        }
    }
...
pub mod PINCFG {
    ...
    pub mod TRGSEL {
        ...
        pub mod RW {
            ...
            pub const TRG_RXD: u32 = 0b01;

            /// 0b10: Input trigger is used instead of CTS_B pin input.
            pub const TRG_CTS: u32 = 0b10;

            /// 0b11: Input trigger is used to modulate the TXD pin output. The TXD pin output (after TXINV configuration) is internally ANDed with the input trigger.
            pub const TRG_TXD: u32 = 0b11;
        }
    }
}
...
pub mod BAUD {
    ...
    pub mod SBNS {
        ...
        pub mod RW {
            ...
            /// 0b0: One stop bit.
            pub const ONE: u32 = 0b0;

            /// 0b1: Two stop bits.
            pub const TWO: u32 = 0b1;
        }
    }
...
pub mod STAT {
    ...
    pub mod PF {
        ...
        pub mod RW {
            ...
            /// 0b0: No parity error.
            pub const NOPARITY: u32 = 0b0;

            /// 0b1: Parity error.
            pub const PARITY: u32 = 0b1;
        }
    }
    ...
    pub mod IDLE {
        ...
        pub mod RW {
            ...
            pub const NOIDLE: u32 = 0b0;

            /// 0b1: Idle line is detected.
            pub const IDLE: u32 = 0b1;
        }
    }
    ...
    pub mod RXINV {
        ...
        pub mod RW {
            ...
            pub const NOT_INVERTED: u32 = 0b0;
    ...
    pub mod MSBF {
        ...
        pub mod RW {
            ...
            pub const LSB_FIRST: u32 = 0b0;

            /// 0b1: MSB (identified as bit9, bit8, bit7 or bit6) is the first bit that is transmitted following the start bit depending on the setting of CTRL\[M\], CTRL\[PE\] and BAUD\[M10\]. .
            pub const MSB_FIRST: u32 = 0b1;
        }
    }
    ...
    pub mod RXEDGIF {
        ...
        pub mod RW {
            ...
            pub const NO_EDGE: u32 = 0b0;

            /// 0b1: An active edge on the receive pin has occurred.
            pub const EDGE: u32 = 0b1;
        }
    }
    ...
    pub mod LBKDIF {
        ...
        pub mod RW {
            ...
            pub const NOT_DETECTED: u32 = 0b0;
...
pub mod CTRL {
    ...
    pub mod ILT {
        ...
        pub mod RW {
            ...
            pub const FROM_START: u32 = 0b0;

            /// 0b1: Idle character bit count starts after stop bit.
            pub const FROM_STOP: u32 = 0b1;
        }
    }
    ...
    pub mod M {
        ...
        pub mod RW {
            ...
            pub const DATA8: u32 = 0b0;

            /// 0b1: Receiver and transmitter use 9-bit data characters.
            pub const DATA9: u32 = 0b1;
        }
    }
    ...
    pub mod IDLECFG {
        ...
        pub mod RW {
            ...
            pub const IDLE_1: u32 = 0b000;

            /// 0b001: 2 idle characters
            pub const IDLE_2: u32 = 0b001;

            /// 0b010: 4 idle characters
            pub const IDLE_4: u32 = 0b010;

            /// 0b011: 8 idle characters
            pub const IDLE_8: u32 = 0b011;

            /// 0b100: 16 idle characters
            pub const IDLE_16: u32 = 0b100;

            /// 0b101: 32 idle characters
            pub const IDLE_32: u32 = 0b101;

            /// 0b110: 64 idle characters
            pub const IDLE_64: u32 = 0b110;

            /// 0b111: 128 idle characters
            pub const IDLE_128: u32 = 0b111;
        }
    }
    ...
    pub mod TXDIR {
        ...
        pub mod RW {
            ...
            pub const TX_INPUT: u32 = 0b0;

            /// 0b1: TXD pin is an output in single-wire mode.
            pub const TX_OUTPUT: u32 = 0b1;
        }
    }
...
pub mod MODIR {
    ...
    pub mod TXRTSE {
        ...
        pub mod RW {
            ...
            /// 0b1: When a character is placed into an empty transmit shift register, RTS asserts one bit time before the start bit is transmitted. RTS deasserts one bit time after all characters in the transmitter FIFO and shift register are completely sent, including the last stop bit.
            pub const ENABLED: u32 = 0b1;
        }
    }
    ...
    pub mod TNP {
        ...
        pub mod RW {
            ...
            /// 0b00: 1/OSR.
            pub const ONE_SAMPLE: u32 = 0b00;

            /// 0b01: 2/OSR.
            pub const TWO_SAMPLE: u32 = 0b01;

            /// 0b10: 3/OSR.
            pub const THREE_SAMPLE: u32 = 0b10;

            /// 0b11: 4/OSR.
            pub const FOUR_SAMPLE: u32 = 0b11;
        }
    }
